...
| 9 | LoRA/PEFT efficient fine-tune option (milestone: user menu option 3) | `pending` | Design + cost only; `peft` install needs EXPLICIT user OK (not installed — bnb diagnostic 2026-09-06); current pipeline stays full fine-tune | research/c12_tier2_brief.md §2 (env note) |
