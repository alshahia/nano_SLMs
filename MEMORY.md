...
- Related discovery: MEMORY.md (0 bytes) and HANDOFF.md (~1 KB) were committed clobbered by 9d9633a / f74d100 / 9be9bdd on 2026-09-21/22 — BEFORE this rewrite (concurrent-session mid-write commits suspected). Restored here from last-full versions 5f1b6a0 (MEMORY, 70,755 chars) and a6e9e38 (HANDOFF, 146,449 chars). Anything recorded only in these two files between those commits survives only in git log messages.
