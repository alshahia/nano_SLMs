...
sd = load_file(str(ROOT / "runs/mex/mu2_g2/final/model.safetensors"))
...
ce_t, acc_t = run("val_task.bin", "G2 val_task (fill-in)")
ce_r, _ = run("holdout_retent.bin", "G2 retention (clean)")
