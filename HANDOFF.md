...
- Artifacts: runs/diac/v2d28/final (+config.yaml), data/diac/bench/v2d28_pred_*.jsonl; smoke dir configs/diac_v2d28_smoke.yaml + runs/diac/v2d28smoke kept until user cleanup call.
